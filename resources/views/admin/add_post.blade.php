            ...
            <div class="bg-white p-4 overflow-hidden shadow-sm sm:rounded-lg">
                <form id="add_form" action="{{route('post.add_post')}}" enctype="multipart/form-data" method="POST" class="row">
                    ...
                    <div class="col-lg-6 p-3" style="border-right: 1px solid #ddd">
                        ...
                        <textarea value="{{old('excerpt')}}" placeholder="Excerpt" style="resize: none" name="excerpt" id="" class="border-gray-300 w-full focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm tinymce-editor" cols="30" rows="3"></textarea>

                        <label required class="mt-2" for="body">Body Text</label>
                        <textarea value="{{old('body')}}" placeholder="Post Body" style="resize: none" name="body" id="" class="border-gray-300 w-full focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm tinymce-editor" cols="30" rows="3"></textarea>

                        <label class="mt-2" for="tag">Tag</label>
                        <select name="tag" class="form-control" id="exampleSelect">
